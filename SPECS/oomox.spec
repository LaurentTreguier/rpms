...
Name:           oomox
Version:        1.3.1
Release:        1_%{numix_version}.1_%{flatplat_version}.2%{?dist}
...
Source2:        https://github.com/nana-4/Flat-Plat/archive/%{flatplat_version}.tar.gz#/Flat-Plat-%{flatplat_version}.tar.gz
