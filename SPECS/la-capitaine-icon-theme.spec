%global         git_date        20180730
%global         git_commit      a3ac190d852c43e5f2ccd05c9e0510c897910106
...
Source0:        https://github.com/keeferrourke/%{name}/archive/v%{version}.zip#/%{name}-%{version}.zip
