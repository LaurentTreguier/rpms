...
%global         lowercase_name  discord-canary
...
Source0:        https://dl-canary.discordapp.net/apps/linux/%{version}/%{lowercase_name}-%{version}.tar.gz#/%{name}-%{version}.tar.gz
...
%changelog
* Thu Mar 30 2017 Laurent Tréguier <laurent@treguier.org> - 0.0.15-5
- added dependencies according to the official deb package

* Thu Mar 30 2017 Laurent Tréguier <laurent@treguier.org> - 0.0.15-4
- changed url for consistent downloads
- corrected copyright location

* Thu Mar 30 2017 Laurent Tréguier <laurent@treguier.org> - 0.0.15-3
- removed postinst.sh
- added link to binary in /usr/bin

* Wed Mar 29 2017 Laurent Tréguier <laurent@treguier.org> - 0.0.15-2
